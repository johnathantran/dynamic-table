...
export const getData = async (url) => {	
    const OPTIONSGET = { ... OPTIONS };
    return await fetch(`${apiBase}${url}`, OPTIONSGET)
                    .then((res) => res.json())
                    .then((data) => {
...
export const postData = async (url, payload) => {	
    ...
    return await fetch(`${apiBase}${url}`, OPTIONSPOST)
                    .then((res) => res.json())
                    .then((data) => {
                        return handleDataFormat(data);
                    }).catch(err => {
...
export const putData = async (url, payload) => {	
    ...
    return await fetch(`${apiBase}${url}`, OPTIONSPUT)
                    .then((res) => res.json())
                    .then((data) => {
                        return handleDataFormat(data);
                    }).catch(err => {
...
export const deleteData = async (url) => {	
    ...
    return await fetch(`${apiBase}${url}`, OPTIONSDELETE)
                    .then((res) => res.json())
                    .then((data) => {
                        return handleDataFormat(data);
                    }).catch(err => {
